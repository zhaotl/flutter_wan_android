...
import 'package:flutter_wan_android/pages/main_page.dart';
import 'package:flutter_wan_android/user.dart';
import 'package:flutter_wan_android/utils/error_handle.dart';
...
Future<void> main() async {
  ...
  handleError(() async {
    ...
    Wanlog.i('mmkv root dir is $rootDir');
    User().loadFromLocal();
    configDio(Constant.baseUrl);
    setPathUrlStrategy();
